...
namespace renom{
    ...
    {
        if (size) {
            cuda_add_bias <<<ceil((size)/256.0), 256, 0, NULL>>> (size, n, wh, bias, a);
        }
    }
    ...
    void thrust_div(VALUE_TYPE *a, VALUE_TYPE *b, VALUE_TYPE *c, size_t size, binop_strides *strides, cudaStream_t stream) {
        if (!size)
            return;
        if(strides->size == 0)cuda_binop0<BinOP_Div> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 1)cuda_binop1<BinOP_Div> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 2)cuda_binop2<BinOP_Div> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 3)cuda_binop3<BinOP_Div> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 4)cuda_binop4<BinOP_Div> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 5)cuda_binop5<BinOP_Div> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else assert(0);  // never reach here
    }
    void thrust_rdiv(VALUE_TYPE *a, VALUE_TYPE *b, VALUE_TYPE *c, size_t size, binop_strides *strides, cudaStream_t stream) {
        if (!size)
            return;
        if(strides->size == 0)cuda_binop0<BinOP_Rdiv> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 1)cuda_binop1<BinOP_Rdiv> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 2)cuda_binop2<BinOP_Rdiv> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 3)cuda_binop3<BinOP_Rdiv> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 4)cuda_binop4<BinOP_Rdiv> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 5)cuda_binop5<BinOP_Rdiv> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else assert(0);  // never reach here
    }
    void thrust_pow(VALUE_TYPE *a, VALUE_TYPE *b, VALUE_TYPE *c, size_t size, binop_strides *strides, cudaStream_t stream) {
        if (!size)
            return;
        if(strides->size == 0)cuda_binop0<BinOP_Pow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 1)cuda_binop1<BinOP_Pow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 2)cuda_binop2<BinOP_Pow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 3)cuda_binop3<BinOP_Pow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 4)cuda_binop4<BinOP_Pow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 5)cuda_binop5<BinOP_Pow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else assert(0);  // never reach here
    }
    void thrust_rpow(VALUE_TYPE *a, VALUE_TYPE *b, VALUE_TYPE *c, size_t size, binop_strides *strides, cudaStream_t stream) {
        if (!size)
            return;
        if(strides->size == 0)cuda_binop0<BinOP_Rpow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 1)cuda_binop1<BinOP_Rpow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 2)cuda_binop2<BinOP_Rpow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 3)cuda_binop3<BinOP_Rpow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 4)cuda_binop4<BinOP_Rpow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else if(strides->size == 5)cuda_binop5<BinOP_Rpow> <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size, *strides);
        else assert(0);  // never reach here
    }
    ...
    void thrust_add_num(VALUE_TYPE *a, VALUE_TYPE b, VALUE_TYPE *c, size_t size, cudaStream_t stream) {
        if (!size)
            return;
        cuda_add_num <<<ceil((size)/256.0), 256, 0, stream>>> (a, b, c, size);
    }
    ...
    void thrust_rpow_num(VALUE_TYPE *a, VALUE_TYPE b, VALUE_TYPE *c, size_t size, cudaStream_t stream) {
        ...
        void thrust_copy_memory_stride(VALUE_TYPE *dest, VALUE_TYPE *src, const size_t src_elems,
                             const size_t size_stride, const size_t size_srcblock) {
            if (src_elems)
                cuda_copy_memory_stride <<<ceil(src_elems/256.0), 256, 0, NULL>>> (dest, src, src_elems, size_stride, size_srcblock);
        }
        ...
        void thrust_transpose(
            ...
            if (size) {
                ...
                cuda_transpose <<<ceil((size)/256.0), 256, 0, NULL>>> (size, shapesize, src, s_src, result, s_result);
            }
        }
        ...
        void thrust_concat_blocks(VALUE_TYPE *a, const size_t nsize, VALUE_TYPE *b, const size_t block_len, const size_t copy_len) {
            if (nsize) {
                cuda_concat_blocks<<<ceil(nsize/256.0), 256, 0, NULL>>> (a, nsize, b, block_len, copy_len);
            }
        }
        ...
        void thrust_getitem(
            ...
            if (result_size) {
                cuda_getitem <<<ceil((result_size)/256.0), 256, 0, NULL>>> (src, result, result_size, *infos);
            }
        }
        ...
        void thrust_setitem(
            ...
            if (src_size) {
                cuda_setitem <<<ceil((src_size)/256.0), 256, 0, NULL>>> (src, src_size, dest, *info);
            }
        }
	...
	void thrust_negate(VALUE_TYPE *first, VALUE_TYPE *last, VALUE_TYPE *output) {
	    ...
	    thrust::transform(thrust::cuda::par.on(NULL), dev_first, dev_last, dev_output, op);
	}
	...
	void thrust_relu_forward(VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		...
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, relu_forward_function());
	}
	...
	void thrust_relu_backward(VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a((VALUE_TYPE*)a);
		thrust::device_ptr<VALUE_TYPE> dev_b((VALUE_TYPE*)b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, relu_backward_function());
	}
	...
	void thrust_leaky_relu_forward(VALUE_TYPE s, VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a((VALUE_TYPE*)a);
		thrust::device_ptr<VALUE_TYPE> dev_b((VALUE_TYPE*)b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, leaky_relu_forward_function(s));
	}
	...
	void thrust_leaky_relu_backward(VALUE_TYPE s, VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a((VALUE_TYPE*)a);
		thrust::device_ptr<VALUE_TYPE> dev_b((VALUE_TYPE*)b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, leaky_relu_backward_function(s));
	}
	...
	void thrust_elu_forward(VALUE_TYPE s, VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a((VALUE_TYPE*)a);
		thrust::device_ptr<VALUE_TYPE> dev_b((VALUE_TYPE*)b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, elu_forward_function(s));
	}
	...
	void thrust_elu_backward(VALUE_TYPE s, VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a((VALUE_TYPE*)a);
		thrust::device_ptr<VALUE_TYPE> dev_b((VALUE_TYPE*)b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, elu_backward_function(s));
	}
  ...
  {
    cuda_softplus_forward<<<size / 256 + 1, 256, 0, NULL>>>(a, b, size);
  }
  ...
  {
    cuda_softplus_backward<<<size / 256 + 1, 256, 0, NULL>>>(a, b, dy, size);
  }
	...
	void thrust_sigmoid(VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a((VALUE_TYPE*)a);
		thrust::device_ptr<VALUE_TYPE> dev_b((VALUE_TYPE*)b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, sigmoid_function());
	}
	...
	void thrust_tanh(VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a((VALUE_TYPE*)a);
		thrust::device_ptr<VALUE_TYPE> dev_b((VALUE_TYPE*)b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, tanh_function());
	}
	...
	void thrust_loge(VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		...
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, loge_function());
	}
	...
	void thrust_exp(VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a(a);
		thrust::device_ptr<VALUE_TYPE> dev_b(b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, exp_function());
	}
	...
	void thrust_sqrt(VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a(a);
		thrust::device_ptr<VALUE_TYPE> dev_b(b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, sqrt_function());
	};
    ...
    void thrust_sign(VALUE_TYPE *a, VALUE_TYPE *b, int size)
    {
        thrust::device_ptr<VALUE_TYPE> dev_a(a);
        thrust::device_ptr<VALUE_TYPE> dev_b(b);
        thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, sign_function());
    };
	...
	void thrust_abs_forward(VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a(a);
		thrust::device_ptr<VALUE_TYPE> dev_b(b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, abs_forward_function());
	}
	...
	void thrust_abs_backward(VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a(a);
		thrust::device_ptr<VALUE_TYPE> dev_b(b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, abs_backward_function());
	}
	...
	{
		thrust::device_ptr<VALUE_TYPE> dev_ptr(a);
		return thrust::reduce(thrust::cuda::par.on(NULL), dev_ptr, dev_ptr + size);
	}
	...
	{
            if (size) {
                cuda_strided_sum <<<ceil((size/axis_size)/256.0), 256, 0, NULL>>> (a, b, stride, axis_size, step, int(size/axis_size));
            }
	}
	...
	void thrust_min(VALUE_TYPE v, VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a(a);
		thrust::device_ptr<VALUE_TYPE> dev_b(b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, min_function(v));
	}
	...
	void thrust_max(VALUE_TYPE v, VALUE_TYPE *a, VALUE_TYPE *b, int size)
	{
		thrust::device_ptr<VALUE_TYPE> dev_a(a);
		thrust::device_ptr<VALUE_TYPE> dev_b(b);
		thrust::transform(thrust::cuda::par.on(NULL), dev_a, dev_a+size, dev_b, dev_b, max_function(v));
	}
    ...
    void thrust_forward_roi_pool2d(int N, VALUE_TYPE *x, float spatial_scale, int channels,
            ...
            VALUE_TYPE *argmax_data)
    {
        cuda_forward_roi_pool2d <<<ceil((N*channels*outh*outw)/256.0), 256, 0, NULL>>>(N, x, spatial_scale, channels,
    ...
    {
        cuda_backward_roi_pool2d <<<ceil((batch_N*channels*height*width)/256.0), 256, 0, NULL>>>(N, du, argmax, rois, spatial_scale, batch_N, channels, height,
                                                                                width, outh, outw, dx);
    }
	...
	{
            if (N * M) {
                cuda_forward_lstm_activate <<<ceil((N*M)/256.0), 256, 0, NULL>>> (N, M, u);
            }
	}
	...
	{
            if (N * M) {
                cuda_forward_lstm <<<ceil((N*M/4)/256.0), 256, 0, NULL>>> (N, M, u, s, ps, z);
            }
	}
	...
	{
            if (N*M) {
                cuda_backward_lstm_activate <<<ceil((N*M)/256.0), 256, 0, NULL>>> (N, M, u);
            }
	}
	...
	{
            if (N*M) {
		cuda_backward_lstm <<<ceil((N*M/4)/256.0), 256, 0, NULL>>> (N, M, u, du, s, ps, e, pfg, dou, next_dou);
            }
	}
    ...
    {
        if (N*M) {
            cuda_forward_peephole_lstm <<<ceil((N*M/4)/256.0), 256, 0, NULL>>> (N, M/4, wc, pstate, state, u, z);
        }
    }
    ...
    {
        if (N * M) {
            cuda_backward_peephole_lstm <<<ceil((N*M/4)/256.0), 256, 0, NULL>>> \
    ...
    */
    ...
    void thrust_binarize(VALUE_TYPE *a, VALUE_TYPE prob, int size, VALUE_TYPE *b){
        if (size) {
            cuda_binalize <<<ceil(size/256.0), 256, 0, NULL>>>(a, prob, size, b);
        }
    }
    ...
    {
        if (N) {
            cuda_embedding_forward <<<ceil(N/256.0), 256, 0, NULL>>> (N, K, M, a, w, y);
        }
    }
    ...
    {
        if (N) {
            cuda_embedding_backward <<<ceil(N/256.0), 256, 0, NULL>>> (N, K, M, a, dy, dx);
        }
    }
    ...
    __global__ void cuda_optimizer_sgd(int Elems, VALUE_TYPE learning_rate, VALUE_TYPE *dy, VALUE_TYPE momentum, VALUE_TYPE *pdy, VALUE_TYPE *ndy)
    {
      int idx = blockIdx.x * blockDim.x + threadIdx.x;
      if (idx < Elems) {
        ndy[idx] = dy[idx] * learning_rate;
        if (pdy != 0)
          ndy[idx] += pdy[idx] * momentum;
      }
    }
    ...
    {
      if(Elems) {
        cuda_optimizer_adagrad<<<ceil(Elems/256.0), 256, 0, NULL>>>(Elems, learning_rate, dy, eps, pdy, ndy, r);
      }
    }
    ...
    {
      if(Elems) {
        cuda_optimizer_rmsprop<<<ceil(Elems/256.0), 256, 0, NULL>>>(Elems, learning_rate, dy, eps, gamma, eta, k, ndy, r);
      }
    }

    __global__ void cuda_optimizer_adam(int Elems, VALUE_TYPE learning_rate, VALUE_TYPE *dy, VALUE_TYPE eps, VALUE_TYPE powered_beta1, VALUE_TYPE beta1, VALUE_TYPE powered_beta2, VALUE_TYPE beta2, VALUE_TYPE min, bool flug, VALUE_TYPE *u, VALUE_TYPE *r, VALUE_TYPE *ndy)
    {
      int idx = blockIdx.x * blockDim.x + threadIdx.x;
      if (idx < Elems) {
        VALUE_TYPE lrt = learning_rate * sqrtf(1 - powered_beta2) / (1 - powered_beta1);
        u[idx] = beta1 * u[idx] + (1.0 - beta1) * dy[idx];
        r[idx] = beta2 * r[idx] + (1.0 - beta2) * dy[idx] * dy[idx];
        ndy[idx] = lrt * u[idx] / (sqrtf(r[idx]) + eps);
      }
    }
    ...
    {
      if(Elems) {
        cuda_optimizer_adam<<<ceil(Elems/256.0), 256, 0, NULL>>>(Elems, learning_rate, dy, eps, gamma, gamma_orig, beta, beta_orig, min, flug, u, r, ndy);
      }
    }
    ...
    {
      if(Elems) {
        cuda_optimizer_adadelta<<<ceil(Elems/256.0), 256, 0, NULL>>>(Elems, decay_rate, epsilon, previous_squared_gradient, previous_squared_delta, dy, new_dy);
      }
    }
    ...
    {
      if(Elems) {
        cuda_optimizer_adamax<<<ceil(Elems/256.0), 256, 0, NULL>>>(Elems, alpha, epsilon, beta1, running_beta1, beta2, running_beta2, moment1, moment2, dy, new_dy);
      }
    }
    ...
    void thrust_get_fg_ary_forward(int N, int M, VALUE_TYPE *ptr1, VALUE_TYPE *ptr2){
        cuda_get_fg_ary_forward <<<ceil(N/256.0), 256, 0, NULL>>> (N, M, ptr1, ptr2);
    }
    ...
    void thrust_get_ith_ary_forward(int N, int M, int i, VALUE_TYPE *ptr1, VALUE_TYPE *ptr2){
        cuda_get_ith_ary_forward <<<ceil(N/256.0), 256, 0, NULL>>> (N, M, i, ptr1, ptr2);
    }
    ...
    void thrust_get_ith_ary_backward(int N, int M, int i, VALUE_TYPE *ptr1, VALUE_TYPE *ptr2){
        cuda_get_ith_ary_backward <<<ceil(N/256.0), 256, 0, NULL>>> (N, M, i, ptr1, ptr2);
    }
    ...
    void thrust_get_nth_ary(int N, int M, int i, int j, VALUE_TYPE *ptr1, VALUE_TYPE *ptr2){
        cuda_get_nth_ary <<<ceil((N*M)/256.0), 256.0, 0, NULL>>> (N, M, i, j, ptr1, ptr2);
    }
    ...
    {
        cuda_assign_pred_box <<<ceil((N*M)/256.0), 256.0, 0, NULL>>> (N, M, x_ptr, y_ptr, h_ptr, w_ptr, ary_ptr);
    }
    ...
    {
        cuda_pred_ctr <<<ceil((N*M)/256.0), 256.0 , 0, NULL>>> (N, M, arg_ptr, length_ptr, ctr_ptr, ary_ptr);
    }
    ...
    {
        cuda_generate_anchors <<<ceil(A*K*N/256.0), 256.0, 0, NULL>>>(A, K, N, shifts_ptr, ratios_ptr, scales_ptr, ratio_size, scale_size, feat_stride, base_size, anchors_ptr);
    }
    ...
    {
        cuda_get_ith_bbox <<<ceil(N*M/256.0), 256.0, 0, NULL>>>(N, M, bbox_ptr, i, ary_ptr);
    }
