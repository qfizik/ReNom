...
namespace renom{
	...
	void thrust_clip(int elem, VALUE_TYPE *array, VALUE_TYPE max, VALUE_TYPE min, VALUE_TYPE *out_array);
	__global__ void cuda_clip(int elem, VALUE_TYPE *array, VALUE_TYPE max, VALUE_TYPE min, VALUE_TYPE *out_array);
